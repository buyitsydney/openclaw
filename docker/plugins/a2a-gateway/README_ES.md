...
| `peers[].name`         | string | _required_ | Nombre visible del par     |
| `peers[].agentCardUrl` | string | _required_ | URL del Agent Card del par |
...
| `routing.rules[].name`           | string | _required_ | Nombre de la regla                                                      |
...
| `routing.rules[].target.peer`    | string | _required_ | Par al que enrutar                                                      |
...
| ------------------------------ | ------ | ------------------------------------------------------------------ |
| `/.well-known/agent-card.json` | GET    | Descubrimiento del Agent Card _(alias: `/.well-known/agent.json`)_ |
