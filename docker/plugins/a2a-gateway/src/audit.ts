...
export class AuditLogger {
  ...
  recordInbound(taskId: string, contextId: string, status: string, durationMs: number): void {
    this.write({
  ...
  recordOutbound(peer: string, ok: boolean, statusCode: number, durationMs: number): void {
    this.write({
      ts: new Date().toISOString(),
      direction: "outbound",
      type: "task",
