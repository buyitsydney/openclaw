...
| `peers[].name`         | string | _required_ | Nome visualizzato del peer   |
| `peers[].agentCardUrl` | string | _required_ | URL dell'Agent Card del peer |
...
| `routing.rules[].name`           | string | _required_ | Nome della regola                                                  |
...
| `routing.rules[].target.peer`    | string | _required_ | Peer verso cui instradare                                          |
...
| ------------------------------ | ------ | ------------------------------------------------------------- |
| `/.well-known/agent-card.json` | GET    | Scoperta dell'Agent Card _(alias: `/.well-known/agent.json`)_ |
