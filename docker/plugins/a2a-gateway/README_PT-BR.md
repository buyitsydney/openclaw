...
| `peers[].name`         | string | _required_ | Nome de exibição do par  |
| `peers[].agentCardUrl` | string | _required_ | URL do Agent Card do par |
...
| `routing.rules[].name`           | string | _required_ | Nome da regra                                                          |
...
| `routing.rules[].target.peer`    | string | _required_ | Par para o qual rotear                                                 |
...
| ------------------------------ | ------ | ------------------------------------------------------------- |
| `/.well-known/agent-card.json` | GET    | Descoberta do Agent Card _(alias: `/.well-known/agent.json`)_ |
