...
| `peers[].name`         | string | _required_ | ピアの表示名             |
| `peers[].agentCardUrl` | string | _required_ | ピアの Agent Card の URL |
...
| `routing.rules[].name`           | string | _required_ | ルール名                                                         |
...
| `routing.rules[].target.peer`    | string | _required_ | ルーティング先のピア                                             |
...
| ------------------------------ | ------ | ------------------------------------------------------------- |
| `/.well-known/agent-card.json` | GET    | Agent Card の検出 _（エイリアス: `/.well-known/agent.json`）_ |
