...
| ---------------------- | ------ | ---------- | -------------------------- |
| `peers`                | array  | `[]`       | 對等代理清單               |
| `peers[].name`         | string | _required_ | 對等節點顯示名稱           |
| `peers[].agentCardUrl` | string | _required_ | 對等節點 Agent Card 的 URL |
...
| `routing.rules[].name`           | string | _required_ | 規則名稱                                 |
...
| `routing.rules[].target.peer`    | string | _required_ | 路由目標的對等節點                       |
