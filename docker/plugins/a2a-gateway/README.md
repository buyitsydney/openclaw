...
| `peers[].name`         | string | _required_ | Peer display name        |
| `peers[].agentCardUrl` | string | _required_ | URL to peer's Agent Card |
...
| `routing.rules[].name`           | string | _required_ | Rule name                                      |
...
| `routing.rules[].target.peer`    | string | _required_ | Peer to route to                               |
...
| ------------------------------ | ------ | --------------------------------------------------------- |
| `/.well-known/agent-card.json` | GET    | Agent Card discovery _(alias: `/.well-known/agent.json`)_ |
