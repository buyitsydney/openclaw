...
| `peers[].name`         | string | _requis_ | Nom d'affichage du pair     |
| `peers[].agentCardUrl` | string | _requis_ | URL de l'Agent Card du pair |
...
| `routing.rules[].name`           | string | _requis_  | Nom de la règle                                                     |
...
| `routing.rules[].target.peer`    | string | _requis_  | Pair vers lequel router                                             |
...
| ------------------------------ | ------ | ---------------------------------------------------------------- |
| `/.well-known/agent-card.json` | GET    | Découverte de l'Agent Card _(alias : `/.well-known/agent.json`)_ |
