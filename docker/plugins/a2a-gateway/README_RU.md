...
| `peers[].name`         | string | _required_ | Отображаемое имя пира |
| `peers[].agentCardUrl` | string | _required_ | URL Agent Card пира   |
...
| `routing.rules[].name`           | string | _required_ | Имя правила                                                        |
...
| `routing.rules[].target.peer`    | string | _required_ | Пир для маршрутизации                                              |
...
| ------------------------------ | ------ | --------------------------------------------------------------- |
| `/.well-known/agent-card.json` | GET    | Обнаружение Agent Card _(псевдоним: `/.well-known/agent.json`)_ |
