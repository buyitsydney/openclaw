...
function createManager(probe: (peer: PeerConfig) => Promise<boolean> = async () => true) {
  return new PeerHealthManager(testPeers, defaultHealthConfig, defaultCbConfig, probe, noopLog);
}
