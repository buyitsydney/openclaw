...
| `peers[].name`         | string | _required_ | Anzeigename des Peers        |
| `peers[].agentCardUrl` | string | _required_ | URL zur Agent Card des Peers |
...
| `routing.rules[].name`           | string | _required_ | Regelname                                                                   |
...
| `routing.rules[].target.peer`    | string | _required_ | Peer, an den weitergeleitet wird                                            |
...
| ------------------------------ | ------ | --------------------------------------------------------- |
| `/.well-known/agent-card.json` | GET    | Agent-Card-Erkennung _(Alias: `/.well-known/agent.json`)_ |
